...
namespace PimpMyRideServer.Migrations
{
    ...
    [Migration("20231123091108_addedInnerJoinTableForPartAndTickets1")]
    partial class addedInnerJoinTableForPartAndTickets1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartTicket", b =>
                {
                    b.Property<string>("partspartId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ticketsticketId")
                        .HasColumnType("int");

                    b.HasKey("partspartId", "ticketsticketId");

                    b.HasIndex("ticketsticketId");

                    b.ToTable("PartTicket");
                });
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.PartTicketJoin", b =>
                {
                    b.Property<string>("partId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("partId", "ticketId");

                    b.HasIndex("ticketId");

                    b.ToTable("PartTicketJoin");
                });
            ...
            modelBuilder.Entity("PartTicket", b =>
                {
                    b.HasOne("PimpMyRideServer.Models.Part", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.PartTicketJoin", b =>
                {
                    b.HasOne("PimpMyRideServer.Models.Part", "part")
                        .WithMany("partTicketJoins")
                        .HasForeignKey("partId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PimpMyRideServer.Models.Ticket", "ticket")
                        .WithMany("partTicketJoins")
                        .HasForeignKey("ticketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
