...
namespace PimpMyRideServer.Migrations
{
    ...
    [Migration("20231225153645_addedLaborsOnCreate")]
    partial class addedLaborsOnCreate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.Labor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9,
                            description = "Brake rotors and pads Replacement",
                            discount = 0.0m,
                            price = 450m,
                            time = 1.5m
                        },
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.Order", b =>
                {
                    ...
                    b.Property<string>("SupplierssupplierId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.OrderPart", b =>
                {
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.Ticket", b =>
                {
                    ...
                    b.Property<double>("totalLaborDiscount")
                        .HasColumnType("float");

                    b.Property<double>("totalLaborPrice")
                        .HasColumnType("float");

                    b.Property<double>("totalPartsDiscount")
                        .HasColumnType("float");

                    b.Property<double>("totalPartsPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.TicketLabor", b =>
                {
                    ...
                    b.ToTable("TicketLabor");
                });

            modelBuilder.Entity("PimpMyRideServer.Models.TicketPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.Order", b =>
                {
                    b.HasOne("PimpMyRideServer.Models.Suppliers", null)
                        .WithMany("orders")
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.OrderPart", b =>
                {
                    b.HasOne("PimpMyRideServer.Models.Order", null)
                        .WithMany("parts")
            ...
            modelBuilder.Entity("PimpMyRideServer.Models.TicketLabor", b =>
                {
                    b.HasOne("PimpMyRideServer.Models.Ticket", null)
                        .WithMany("labors")
